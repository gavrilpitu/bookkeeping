...
const BookkeeperCostCalculator: React.FC = () => {
  ...
  const total = baseSalary + payrollTax + benefits + pto + recruiting + software + training;
        ...
        <div className="border border-gray-200 rounded">
          <table className="w-full text-sm border-collapse">
            ...
            <tbody>
              ...
              <tr className="border-b border-gray-100">
                <td className="py-3 px-4 text-gray-800">QuickBooks / software licenses</td>
                <td className="py-3 px-4 text-right text-gray-800 tabular-nums">{fmt(software)}</td>
                <td className="py-3 px-4 text-right text-gray-800 tabular-nums">$75</td>
              </tr>
